      ...
      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
        <SearchIcon
          className={classNames(
            `w-5 h-5`,
            props.config.defaultValue ? 'text-purple' : ' text-gray-500',
          )}
        />
      </div>
      <input
        ...
        className={classNames(
          ...
          'block h-14 w-full shadow-md sm:text-lg text-black text-base disabled:bg-gray-100 p-4 font-titillium outline-none focus:shadow-input',
        )}
