...
const NGOSearch = ({ showFilters }: NGOSearchProps) => {
  ...
  return (
    <div className="bg-yellow w-full bg-search bg-no-repeat bg-cover bg-center">
      <div className="wrapper flex flex-col gap-8 items-center 2xl:w-[70%] lg:max-w-screen-lg">
