...
const ContactInputField = (props: {
  config: Partial<ContactInputFieldConfig>;
  readonly?: boolean;
  disabled?: boolean;
}) => {
  return (
        ...
        {!props.readonly && (
          <input
            ...
            className={classNames(
              ...
              'block rounded-md w-full border border-gray-300 shadow-sm body-text disabled:bg-gray-150 py-2 px-3 outline-none focus:shadow-input',
            )}
